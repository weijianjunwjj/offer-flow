...
* PRD 版本：v2.1；
* 代码实施：尚未开始；
* Traceability 中所有实施项应保持 `Not Started`；
* 在用户明确批准 v0.8 文档冻结和开始实施前，不得修改业务代码、数据库结构或浏览器扩展代码；
* 文档准备完成不等于获得实施授权。
...
1. V8-1 领域模型与 migration；
2. V8-2 当前页采集桥与导入预览；
3. V8-3 标准化、去重、变化与规则预检；
4. V8-4 任务和单岗位 AI 分析；
5. V8-5 推荐、误区和 RadarAction；
6. V8-6 晋升、评测与发布验收。
