# OfferPilot / 求职作战台 · Codex 工作指令

## 1. 角色定位

你是 OfferPilot v0.1 的代码执行者 / 审查员 / 接力开发者。
...
OfferPilot 不使用单个大 SPEC，而采用“分域唯一信源”。
...
OfferPilot v0.1 是本地优先的 AI 求职手账，服务 Boss 直聘前端求职场景。
...
4. 是否发现 P0 之外功能
5. 是否更新了 progress.md
6. 是否应更新 decision-log.md
7. 是否允许进入下一步

审查时不得只审代码，也必须审文档是否同步。
