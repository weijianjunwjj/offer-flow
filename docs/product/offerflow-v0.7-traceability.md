...
- 当前结论：v0.7 产品实施中，禁止发布；G1–G5 均已经用户验收；G6-A 已完成；G6-B（真实生产切换）已于 2026-07-16 经授权执行（真实库已升级 schema v6、G4/G5 正式入口已开放）；G6 等待用户最终生产验收；仍未授权 push/合并 main/Tag/Release
