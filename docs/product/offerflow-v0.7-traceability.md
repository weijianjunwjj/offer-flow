...
- 当前结论：G1–G5 已验收；G6-A 已完成；G6-B（真实生产切换）已执行；**G6 已于 2026-07-16 经用户最终生产验收通过并封板，v0.7 产品与生产验收完成**；App 版本已于 2026-07-16 版本号封板为 0.7.0；仍未授权 push/合并 main/Tag/Release（“验收完成”“版本号封板”均≠“已发布”）
