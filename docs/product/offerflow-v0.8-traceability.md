...
| RC-05 | 重复与变化 | P0-06 / US-03 | 5 | 5.1 | V8-3 | Implemented（沙箱/演练 schema≥v8；生产仍 v7。证据 `docs/evidence/offerflow-v0.8-v8-3-review-workbench-2026-07-23.md`） | fixture、Diff 截图、hash 结果 |
| RC-06 | 透明规则 | P0-07 / US-04 | 4.7 | 3 / 4 | V8-3 | Implemented（沙箱/演练 schema≥v8；生产仍 v7。证据 `docs/evidence/offerflow-v0.8-v8-3-review-workbench-2026-07-23.md`） | 命中原文、覆盖动作截图 |
