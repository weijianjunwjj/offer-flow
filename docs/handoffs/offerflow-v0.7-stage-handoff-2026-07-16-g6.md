...
- **G6 已于 2026-07-16 经用户最终生产验收通过并封板**（用户反馈“测试过了没啥问题。”），OfferFlow v0.7 产品与生产验收完成——详见 `offerflow-v0.7-final-acceptance-2026-07-16.md`。
- App 版本已于 2026-07-16 版本号封板为 `0.7.0`；**仍未授权 push、合并 main、Tag、Release**（“验收完成”“版本号封板”均不等于“已发布”，各发布动作须用户单独授权）。
- **不得**写为：v0.7 已发布 / main 已合并 / 已 push / 已创建 Tag/Release。
