...
- 重要边界：**“验收完成”不等于“已经发布”**。App 版本已于 2026-07-16 版本号封板为 `0.7.0`（package.json / package-lock.json / UI 顶部徽标）；但版本号封板不等于发布——push、合并 main、创建 Tag、创建 Release 均**尚未授权**，各自须由用户单独明确授权。
...
- App 版本已于 2026-07-16 版本号封板为 `0.7.0`（仅版本号封板；尚未 push 新提交、尚未合并 main、尚未创建 Tag、尚未发布 GitHub Release）。
